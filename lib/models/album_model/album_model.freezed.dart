    ...
    return _then(_value.copyWith(
      ...
      productUrl: freezed == productUrl
          ...
          : productUrl // ignore: cast_nullable_to_non_nullable
              as String?,
      isWriteable: freezed == isWriteable
          ? _value.isWriteable
...
class _$AlbumModelImpl implements _AlbumModel {
  const _$AlbumModelImpl(
      ...
      @JsonKey(name: 'isWriteable') this.isWriteable,
      @JsonKey(name: 'mediaItemsCount') this.mediaItemsCount,
      @JsonKey(name: 'coverPhotoBaseUrl') this.coverPhotoBaseUrl,
      @JsonKey(name: 'coverPhotoMediaItemId') this.coverPhotoMediaItemId});
  ...
  @override
  String toString() {
    return 'AlbumModel(id: $id, title: $title, productUrl: $productUrl, isWriteable: $isWriteable, mediaItemsCount: $mediaItemsCount, coverPhotoBaseUrl: $coverPhotoBaseUrl, coverPhotoMediaItemId: $coverPhotoMediaItemId)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, productUrl,
      isWriteable, mediaItemsCount, coverPhotoBaseUrl, coverPhotoMediaItemId);
